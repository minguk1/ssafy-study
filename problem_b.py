...
def vote_average_movies():
    ...
    avg_up_list = [] #평점 8점 이상인 영화들을 모으기 위해 빈 리스트를 만들어 놨습니다.
    for i in popular_movie_list:
      if i["vote_average"] >= 8: #불러온 인기 영화들의 리스트 정보에서 평점 8점 이상이면
        avg_up_list.append(i) #그 영화 정보 딕셔너리를 미리 만들어 놓은 리스트에 넣습니다.
    return avg_up_list
    # 여기에 코드를 작성합니다.  
